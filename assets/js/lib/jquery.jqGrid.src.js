  ...
  $.fn.jqGrid = function (pin) {
    ...
    return this.each(function () {
      ...
      $("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>")
        ...
        .insertBefore(gv);
      $(
        "<div class='loading ui-state-default ui-state-active' id='load_" + this.id + "'>" + '<img src="./resources/images/ajax_indicator_default.gif" style="max-width: 100%;" />' + '</div>',
      ).insertBefore(gv);
      ...
      var sortkeys = ['shiftKey', 'altKey', 'ctrlKey'],
        ...
        addMulti = function (rowid, pos, irow, checked) {
          var v =
              '<input role="checkbox" type="checkbox"' + ' id="jqg_' + ts.p.id + '_' + rowid + '" class="cbox" name="jqg_' + ts.p.id + '_' + rowid + '"' + (checked ? 'checked="checked"' : '') + '/>',
                  ...
                  $.extend(
                    {
                      ...
                      error: function (xhr, st, err) {
                        if (xhr.responseText == 'requireLoginForAjax') {
        ...
        setPager = function (pgid, tp) {
          ...
          if (ts.p.pginput === true) {
            pginp =
              ...
              dir +
              "'>" +
              $.jgrid.format(ts.p.pgtext || '', "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(pgid) + "'></span>") +
              '</td>';
          }
          if (ts.p.pgbuttons === true) {
        ...
        getOffset = function (iCol) {
          var i,
            ret = {},
            brd1 = $.jgrid.cell_width ? 0 : ts.p.cellLayout;
          ret[0] = ret[1] = ret[2] = 0;
          for (i = 0; i <= iCol; i++) {
      ...
      firstr = null;
      var hTable = $(
          "<table class='ui-jqgrid-htable' style='width:" + ts.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>",
        ).append(thead),
      ...
      $(grid.bDiv)
        .append(
          $('<div style="position:relative;' + (isMSIE && $.browser.version < 8 ? 'height:0.01%;' : '') + '"></div>')
            .append('<div></div>')
            .append(this),
        )
...
(function ($) {
  ...
  $.fn.fmatter.actions = function (cellval, opts) {
    ...
    str +=
      "<div title='" + $.jgrid.edit.bCancel + "' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' " + ocl + "><span class='ui-icon ui-icon-cancel'></span></div>";
        ...
        ruleFieldSelect.bind('change', function () {
          ...
          $('.input-elm', trpar).bind('change', function (e) {
            ...
            setTimeout(function () {
              var elem = e.target;
              rule.data =
                elem.nodeName.toUpperCase() === 'SPAN' && cm.searchoptions && $.isFunction(cm.searchoptions.custom_value)
                  ? cm.searchoptions.custom_value($(elem).children('.customelement:first'), 'get')
                  : elem.value;
              that.onchange(); // signals that the filter has changed
            }, tmo);
          });
      ...
      return this.each(function () {
        ...
        if ($('#' + $.jgrid.jqID(IDs.themodal))[0] !== undefined) {
          ...
          var dh = isNaN(p.dataheight) ? p.dataheight : p.dataheight + 'px',
            frm = $("<form name='FormPost' id='" + frmgr + "' class='FormGrid' onSubmit='return false;' style='width:100%;overflow:auto;position:relative;height:" + dh + ";'></form>").data(
              'disabled',
              false,
            ),
...
(function ($) {
  ...
  $.jgrid.extend({
    ...
    addSubGridCell: function (pos, iRow) {
      ...
      return (
        '<td role="gridcell" aria-describedby="' + sid + '_subgrid" class="ui-sgcollapsed sgcollapsed" ' + prp + "><a href='javascript:void(0);'><span class='ui-icon " + ic + "'></span></a></td>"
      );
    },
          ...
          if ($(ts.rows[i]).hasClass('jqgrow')) {
            $(ts.rows[i].cells[pos]).bind('click', function () {
              ...
              if ($(this).hasClass('sgcollapsed')) {
                ...
                $(this)
                  .html("<a href='javascript:void(0);'><span class='ui-icon " + ts.p.subGridOptions.minusicon + "'></span></a>")
                ...
                $(this)
                  .html("<a href='javascript:void(0);'><span class='ui-icon " + ts.p.subGridOptions.plusicon + "'></span></a>")
  ...
  $.jgrid.extend({
    ...
    jqGridExport: function (o) {
      ...
      this.each(function () {
        ...
        var key,
          gprm = $.extend(true, {}, $(this).jqGrid('getGridParam'));
