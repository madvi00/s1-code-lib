...
- 버튼 사이즈: `btn`(기본 28px·xxsmall) / `.btn-medium`(34px·xsmall) / `.btn-large`(44px·medium). PC Button 사이즈 라벨은 v1.1.1에서 sm/md/lg → xxsmall/xsmall/medium으로 재정비됨. README 컴포넌트 표에서 최신 이름 확인.
